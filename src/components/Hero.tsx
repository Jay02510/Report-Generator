        ...
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div className="pt-3 flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-[#F97316] hover:bg-[#EA580C] text-white font-bold text-sm sm:text-base rounded-full shadow-[0_8px_32px_rgba(249,115,22,0.25)] hover:shadow-[0_12px_40px_rgba(249,115,22,0.35)] hover:scale-[1.02] transition-all flex items-center justify-center space-x-2"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-[#0F1014] border border-white/10 hover:border-white/20 hover:bg-[#181a20] text-[#FDFAF5] font-semibold text-sm sm:text-base rounded-full transition-all flex items-center justify-center space-x-2"
            >
